...
hess_out_img = acq_data.create_uniform_image(value=1, xy=nxny)

obj_fun.accumulate_Hessian_times_input(current_estimate, input_img, subset=0)
hess_out_img2 = obj_fun.accumulate_Hessian_times_input(current_estimate, input_img, subset=0, out=hess_out_img)
...
ax[2].set_title('Hessian(cur. estimate) times input', fontsize = 'medium')
fig.show()